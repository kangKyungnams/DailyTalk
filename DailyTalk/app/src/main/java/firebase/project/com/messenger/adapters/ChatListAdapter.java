package firebase.project.com.messenger.adapters;
...
import firebase.project.com.messenger.customviews.RoundedImageView;
import firebase.project.com.messenger.models.Chat;
import firebase.project.com.messenger.models.Message;
import firebase.project.com.messenger.views.ChatFragment;
...
public class ChatListAdapter extends RecyclerView.Adapter<ChatListAdapter.ChatHolder> {
    ...
    private SimpleDateFormat sdf = new SimpleDateFormat("MM/dd aa\nhh:mm");
